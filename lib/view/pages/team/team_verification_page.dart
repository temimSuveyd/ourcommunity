...
import '../../../controller/team/team_verification_controller.dart';
...
class TeamVerificationPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String teamName = Get.arguments?['teamName'];
    final TeamVerificationController controller =
    Get.put(TeamVerificationController());

    return Scaffold(
      backgroundColor: Colors.grey[100],
      appBar: CustomAppBar('Verify Team $teamName', () => Get.back()),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 24.h),
              const Text(
                "The document will be reviewed by our team.",
                style: TextStyle(
                  fontSize: 13,
                  color: Colors.grey,
...
class VerificationInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(
      "To increase your team's credibility, please provide an official document proving the team or organizer's identity.",
      style: TextStyle(
        fontSize: 14.sp,
