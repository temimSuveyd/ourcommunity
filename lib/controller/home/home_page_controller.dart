...
import 'package:ourcommunity/view/pages/favorite/favourite_page.dart';
import 'package:ourcommunity/view/pages/homepage/home_pagebody.dart';
import 'package:ourcommunity/view/pages/profile/profile_page.dart';
...
abstract class HomeController extends GetxController {
  ...
  goToEventDetails(EventModel eventModel);
}
...
// deelete this data
  ...
  final List<Widget> pages = [
    ...
    const GroupInvitationsViewPage(),
    const ProfilePage(),
  ];
  ...
  getAllFavoriteEvents() {
    try {
      statusreqest(Statusreqest.loading);
      favoriteEventsData.getAllFavoriteEventsIdAsStream(userId: userId!).listen(
        (value) {
